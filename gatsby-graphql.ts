...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___active'
  | 'childrenMdx___frontmatter___url'
  | 'childrenMdx___frontmatter___githubUrl'
  | 'childrenMdx___slug'
  | 'childrenMdx___body'
  ...
  | 'childMdx___frontmatter___active'
  | 'childMdx___frontmatter___url'
  | 'childMdx___frontmatter___githubUrl'
  | 'childMdx___slug'
  | 'childMdx___body'
  | 'childMdx___excerpt'
  | 'childMdx___headings'
...
export type SitePluginFieldsEnum =
  ...
  | 'pluginOptions___gatsbyRemarkPlugins___options___isIconAfterHeader'
